* DONE Let's Build A Forum with Laravel and TDD
  CLOSED: [2018-08-08 Wed 08:11]
  - State "DONE"       from "STARTED"    [2018-08-08 Wed 08:11]
...
** DONE We Need a Regression Test
   CLOSED: [2018-08-06 Mon 13:53]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 13:53]
   ...
   - Tests
     - =a_thread_with_a_title_that_ends_in_a_number_should_generate_the_propper_slug= in =CreateThreadsTest=
   - Use model event =created= to create Thread slug

** DONE Mark the Best Reply: Part 1
   CLOSED: [2018-08-06 Mon 14:19]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 14:19]
   Our next feature to implement is one that allows the creator of a thread to mark any reply as the best answer. Let's begin by implementing the underlying server-side logic. Once complete, is the following episode, we can move on to the front-end side of things.
   - Tests
     - =a_thread_creator_may_mark_any_reply_as_the_best_reply= in =BestReplyTest=
     - =it_knows_if_it_is_the_best_reply= in =ReplyTest=
     - =only_a_thread_creator_may_mark_a_reply_test= in =BestReplyTest=

** DONE Mark the Best Reply: Part 2
   CLOSED: [2018-08-06 Mon 14:31]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 14:31]
...
** DONE Refactoring Authorization
   CLOSED: [2018-08-06 Mon 14:55]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 14:55]
...
** DONE Remembering a Best Reply
   CLOSED: [2018-08-06 Mon 16:00]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 16:00]
...
** DONE Confusing Errors and Solutions
   CLOSED: [2018-08-06 Mon 16:24]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 16:24]
   ...
   - Tests
     - =if_a_best_reply_is_deleted_then_the_thread_in_properly_updated_to_reflect_that= in =BestReplyTest=
   - Database set foreign key
     #+BEGIN_SRC php
       $table->foreign('best_reply_id')->references('id')->on('replies')->onDelete('set null');
     #+END_SRC
   - Migration table with foregin tables, careful the migrate timestamps
   - SQLite foreign key not support
     - Solution: =DB::statement('PRAGMA foreign_keys=on')=

** DONE Thread Authorization
   CLOSED: [2018-08-06 Mon 16:34]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 16:34]
   ...
   - prop name use =data-reply= for example.

** DONE An Administrator May Lock Any Thread
   CLOSED: [2018-08-06 Mon 16:52]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 16:52]
   Next up, we need to begin adding the ability to lock any forum thread. Whether a conversation veers far off course, or the administrator simply wants to respond a thread and then close it, this is a common feature for any forum. Let's get started implementing it with TDD.
   - Tests
     - =an_administrator_can_lock_any_thread= in =LockThreads=
     - =a_thread_maybe_locked= in =ThreadTest=

** DONE An Administrator May Lock Any Thread: Part 2
   CLOSED: [2018-08-06 Mon 17:18]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 17:18]
   ...
   - Tests
     - =once_locked_a_thread_may_not_receive_new_replies= in =LockThreadsTest=
     - =non_administrator_may_not_lock_threads= in =LockThreadsTest=
     - =administrator_can_lock_threads= in =LockThreadsTest=
   - Dedicated =LockedThreadsController=

** DONE An Administrtator May Lock Any Thread: Part 3
   CLOSED: [2018-08-06 Mon 17:32]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 17:32]
...
** DONE An Administrator May Lock Any Thread: Part 4
   CLOSED: [2018-08-06 Mon 17:52]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 17:52]
   ...
   - Tests
     - =administrator_can_unlock_threads= in =LockThreadTest=

** DONE From Laravel 5.4 to Laravel 5.5
   CLOSED: [2018-08-06 Mon 18:05]
   - State "DONE"       from "STARTED"    [2018-08-06 Mon 18:05]
   Let's allocate some time in this episode to upgrade our Laravel installation from version 5.4 to 5.5. As you'll see, because we have a full suit of tests to back us up, we can perform this upgrade with incredible confidence.

** DONE Recaptcha
   CLOSED: [2018-08-07 Tue 09:48]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 09:48]
...
** DONE Recaptcha Refactoring
   CLOSED: [2018-08-07 Tue 10:08]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 10:08]
   ...
   - =Tests=
     - =a_thread_requires_recaptcha_verification= in =CreateThreadsTest=
   - Mock
     #+BEGIN_SRC php
       ...
       // unbind the singleton instance
       unset(app()[Recaptcha::class]);

     #+END_SRC

** DONE A Thread Can Be Updated
   CLOSED: [2018-08-07 Tue 12:54]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 12:54]
   ...
   - Tests
     - =a_thread_can_be_updated= in =CreatedThreadTests=
     - =a_thread_requires_a_title_and_a_body_to_be_updated=
     - =unauthorized_users_may_not_update_threads=

** DONE A Thread Can Be Updated: Part 2
   CLOSED: [2018-08-07 Tue 13:46]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 13:46]

** DONE A Thread Can Be Updated : Part 3
...
** DONE First Class Search: Scout Review
   CLOSED: [2018-08-07 Tue 21:42]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 21:42]
...
** DONE First Class Search: Implementation
   CLOSED: [2018-08-07 Tue 22:14]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 22:14]
   ...
   - Tests
     - =a_user_can_search_threads= in =SearchTest=

** DONE First Class Search: Faceting and Ranking
   CLOSED: [2018-08-07 Tue 22:23]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 22:23]
   At this point, we have a fully functional search system in place. However, it might be nice to offer more interactive results. What if the user could instantly filter all search results according to a given facet, such as a tag or channel name? Let's begin preparing such a thing in this episode.

** DONE First Class Search: Instant Results
   CLOSED: [2018-08-07 Tue 22:43]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 22:43]
...
** DONE First Class Search: Forum Intergration
   CLOSED: [2018-08-07 Tue 22:57]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 22:57]
   Now that we have a solid understanding of how to work Algolia and the VueInstantSearch Pluign, let's fully integrate it into our forum.

** DONE WYSIWYG
   CLOSED: [2018-08-07 Tue 23:21]
   - State "DONE"       from "STARTED"    [2018-08-07 Tue 23:21]
...
** DONE WYSIWYG: Part 2
   CLOSED: [2018-08-07 Tue 23:45]
   - State "DONE"       from              [2018-08-07 Tue 23:45]
...
** DONE Sanitizing Is a Must
   CLOSED: [2018-08-08 Wed 00:12]
   - State "DONE"       from "STARTED"    [2018-08-08 Wed 00:12]
   ...
   - Tests
     - =a_thread_body_is_sanitized_automatically= in =ThreadsTest=
     - =a_reply_body_is_sanitized_automatically= in =ReplyTest=

** DONE Onward
   CLOSED: [2018-08-08 Wed 00:18]
   - State "DONE"       from "STARTED"    [2018-08-08 Wed 00:18]
   This series has easily been the most depth course Laracasts has ever released, but the reality is there's so much more to do. As such, let's migrate the end result of all our work to a brand new series that'll pick up right where we left off: "How to Manage an Open Source Project."
