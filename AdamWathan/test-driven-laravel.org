* DONE Getting the Ball Rolling
  CLOSED: [2018-08-21 Tue 09:17]
  - State "DONE"       from              [2018-08-21 Tue 09:17]
...
** DONE Testing Events
   CLOSED: [2018-08-20 Mon 15:37]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 15:37]
   In this lesson we decide on a design for our poster image processing feature and start by test-driving an event.
   - Tests
     - =an_event_is_fired_when_a_concert_is_fired= in =AddConcertTest= =unit=
   - Summary
     - Test Email
       #+BEGIN_SRC php
         Event::fake([ConcertAdded::class]);
         // ...
         Event::assertDispatched(ConcertAdded::class, closure);
       #+END_SRC
** DONE Testing the Event Listener
   CLOSED: [2018-08-20 Mon 15:59]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 15:59]
   In this lesson we drive out our =SchedulePosterImageProcessing= event listener with TDD.
   - Tests
     - =it_queues_a_job_to_process_a_poster_image_if_a_poster_image_is_present= in =SchedulePosterImageProcessingTest= =unit=
     - =a_job_is_not_queued_if_a_poster_is_not_present= in =SchedulePosterImageProcessingTest= =unit=
   - Summary
     - =assertDispatched= vs =assertPushed=

** DONE Resizing the Posted Image
   CLOSED: [2018-08-20 Mon 16:14]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 16:14]
   In this lesson we walk through how to test resizing images using the =Intervention Image= image processing library.
   - Tests
     - =it_resizes_the_poster_image_to_600px_width= in =ProcessPosterImageTest= =unit=
   - Summary
     - =__fixtures__= folder
     - php method =getimagesizefromstring($image)=

** DONE Optimizing the Image Size
   CLOSED: [2018-08-20 Mon 16:34]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 16:34]
   ...
   - Tests
     - =it_optimizes_the_poster_image= in =ProcessPosterImageTest= =unit=
   - Summary
     - Optimized image =limitColor(255)=

* Inviting Promoters and Accepting Inivitations

** DONE Upgrading Laravel and Deleting Some Code
   CLOSED: [2018-08-20 Mon 16:40]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 16:40]
   ...
   - Summary
     - =from= method
     - =assertViewIs= method
     - =withoudExceptionHandling= method

** DONE Viewing an Unused Invitation
   CLOSED: [2018-08-20 Mon 17:01]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 17:00]
   In this lesson, we drive out the ability for a promoter to view their inivitation to join TicketBeast.
   - Tests
     - =viewing_an_unused_invitation= in =AcceptInvitationTest= =unit=
   - Summary
     - Create a test, and let the test pass.

** DONE Viewing Used or Invalid Invitations
   CLOSED: [2018-08-20 Mon 17:12]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 17:12]
   ...
   - Tests
     - =viewing_an_used_invitation= in =AcceptInvitationTest= =feature=
     - =viewing_an_invitation_that_do_not_exist= in =AcceptInvitationTest= =feature=
   - Summary
     - =abort_if=

** DONE Registering with a Valid Invitation
   CLOSED: [2018-08-20 Mon 17:32]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 17:32]
   In this lesson we drive out the form endpoint for registering with a valid invitation code.
   - Tests
     - =registering_with_a_valid_invitation_code= in =AcceptInvitationTest= =unit=
   - Summary
     - =Hash::check()= check password
     - =assertAuthenticatedAs($user)=

** DONE Registering with an Invalid Invitation
   CLOSED: [2018-08-20 Mon 17:38]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 17:38]
   In this lesson we make sure that users can't register with invalid invitation codes.
   - Tests
     - =registering_with_an_used_inivation_code= in =AcceptInvitationTest= =unit=
     - =registering_with_an_invitation_code_that_does_not_exist= in =AcceptInvitationTest= =unit=

** DONE Validating Promoter Registration
   CLOSED: [2018-08-20 Mon 17:45]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 17:45]
   In this lesson we add some validation rules to our registeration flow.
   - Tests
     - =email_is_required= in =AcceptInvitationTest= =feature=
     - =email_is_must_be_unique= in =AcceptInvitationTest= =feature=
     - =password_is_required= in =AcceptInvitationTest= =feature=

** DONE Testing a Console Command
   CLOSED: [2018-08-20 Mon 18:10]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 18:10]
   In this lesson we TDD a custom Artisan command for creating new invitations.
   - Tests
     - =inviting_a_promoter_via_the_cli= in =InvitatePromoterTest= =feature=
   - Summary
     - =$this->artisan('my-command', [])= test Artisan Command.

** DONE Sending Promoters an Invitation Email
   CLOSED: [2018-08-20 Mon 20:04]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 20:04]
   In this lesson we enhance our custom command to also send an invitation email to the promoter being invited.
   - Summary
     - Encapsulate send email logic in the =Inivitation= model.

** DONE Test-Driving the Email Contents
   CLOSED: [2018-08-20 Mon 20:17]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 20:17]
   In this lesson we make sure that the inivitation email contains the correct invitation link, and run through a quick demo of our finished feature.
   - Tests
     - =email_contains_a_link_to_accept_the_invitation= in =InvitationEmailTest= =unit=
     - =email_contains_a_subject in =InvitationEmailTest= =unit=

* Automating Payouts With Stripe Connect
** DONE Getting Cozy with Stripe Connect
   CLOSED: [2018-08-20 Mon 20:31]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 20:31]
  In this lesson, we learn about how tStripe Connect works and drive out an initial test for the OAuth redirect flow using Laravel Dusk.
  - Tests
    - =connecting_a_stripe_account_successfully= in =ConnectWithStripeTest= =unit=

** DONE Authorizing with Stripe
   CLOSED: [2018-08-20 Mon 20:50]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 20:50]
...
** DONE Exchanging Tokens
   CLOSED: [2018-08-20 Mon 21:14]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 21:14]
...
** DONE Unit Testing Middleware
   CLOSED: [2018-08-20 Mon 21:30]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 21:30]
   In this lesson we work on driving out a middleware that will force promoters to connect a Stripe account.
   - Tests
     - =users_without_a_stripe_account_are_forced_to_connect_with_stripe= in =ForceStripeAccountTest= =unit=
   - Summary
     - test driven out =middleware=.

** DONE Testing Callbacks with Invokables
   CLOSED: [2018-08-20 Mon 22:05]
   - State "DONE"       from "STARTED"    [2018-08-20 Mon 22:05]
   ...
   - Tests
     - =users_with_a_stripe_account_can_continue= in =ForceStripeAccountTest= =unit=
   
** DONE Testing That Middleware is Applied
   CLOSED: [2018-08-21 Tue 07:28]
   - State "DONE"       from "STARTED"    [2018-08-21 Tue 07:28]
   ...
   - Tests
     - =middleware_is_applied_to_all_backstage_routes= in =ForceStripeAccountTest= =unit=
   - Summary
     - =Route::getRoutes()->getByName($route)->gatherMiddleware= get specified route middleware.

** DONE Updating Factories and a Speed Trick
   CLOSED: [2018-08-21 Tue 07:34]
   - State "DONE"       from "STARTED"    [2018-08-21 Tue 07:34]
   ...
   - Summary
     - Change use =bcrypt()= to direct password in factory, so that can speed up test.

** DONE Total Charges for a Specific Account
   CLOSED: [2018-08-21 Tue 07:53]
   - State "DONE"       from "STARTED"    [2018-08-21 Tue 07:53]
   ...
   - Tests
     - =can_get_total_charges_for_a_specific_account= in =FakePaymentGatewayTest= =unit=
   - Summary
     - Add =destinationAccountId= in =PaymentGateway= inteface.

** DONE Paying Promoters Directly
   CLOSED: [2018-08-21 Tue 08:03]
   - State "DONE"       from "STARTED"    [2018-08-21 Tue 08:03]
   ...
   - Summary
     - After add =destinationAccountId=, let feature test pass.

** DONE Splitting Payments with Stripe
   CLOSED: [2018-08-21 Tue 09:10]
   - State "DONE"       from "STARTED"    [2018-08-21 Tue 09:10]
   In this lesson we update our =StripePaymentGateway= to match our new payment gateway contract, and add an additional test to make sure that payments processed by Strip are split as expected between the application account and the promoter's account.
   - Tests
     - =ninety_percent_of_the_payment_is_transfered_to_the_destination_account= in =StripePaymentGatewayTest= =unit=
   - Summary
     - Let real stripe payment gateway test pass.

** DONE It's Alive
   CLOSED: [2018-08-21 Tue 09:17]
   - State "DONE"       from "STARTED"    [2018-08-21 Tue 09:17]
